...
This module is for PE2018+ with agents capable of running tasks.  It is currently limited to the Red Hat and Debian operating system.  Windows (WSUS) support is being actively worked on.
